    ...
    return (
        <form className="w-100 px-5">
            ...
            <div className="mt-4">
                ...
                <input value={formData.productprice} name="productprice" type="text" className="form-control" onChange={handleChange} />
            </div>

            <div className="mt-4">
                <label clasName="h3 form-label">Order Detail Company Name</label>
                <input value={formData.orderingcompanyname} name="orderingcompanyname" type="text" className="form-control" onChange={handleChange} />
            </div>
